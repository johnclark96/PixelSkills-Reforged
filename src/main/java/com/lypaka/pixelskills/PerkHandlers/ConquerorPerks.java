...
public class ConquerorPerks {
    ...
    private static void givePerk (String task, Player player) throws ObjectMappingException {
        ...
        int amount = Integer.parseInt(PerkGetters.getPerkModifiers(7, task).get("Amount"));
        String[] modifier = PerkGetters.getPerkModifiers(7, task).get("Modifier").split(" ");
        ...
        if (modifier[1].equalsIgnoreCase("%player-level%")) {
            ...
            num = AccountsHandler.getLevel("Conqueror", player);
    ...
    private static void giveCustomPerk (Player player) throws ObjectMappingException {
        ...
        int options = PerkGetters.getCustomPerkAmount(7);
        ...
        if (options > 1) {
            ...
            map = PerkGetters.getCustomPerkMap(7, rng);
            perkNum = rng;

        } else {

            map = PerkGetters.getCustomPerkMap(7, 1);
            perkNum = 1;
        ...
        if (modifier[1].equalsIgnoreCase("%player-level%")) {
            ...
            modNum = AccountsHandler.getLevel("Conqueror", player);
