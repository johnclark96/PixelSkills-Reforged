...
public class GladiatorPerks {

    public static int modifiedMoney;
    public static int modifiedEXP;
    ...
    private static void givePerk (String task, Player player) throws ObjectMappingException {
        ...
        String[] modifier = PerkGetters.getPerkModifiers(10, task).get("Modifier").split(" ");
        String function = modifier[0];
        double num;

        if (modifier[1].equalsIgnoreCase("%player-level%")) {

            num = AccountsHandler.getLevel("Gladiator", player);
            ...
            case "add":
                ...
                switch (task) {
                    ...
                    case "Defeating-NPC-Trainers":
                        ...
                        modifiedMoney = (int) (Gladiator.originalMoney + num);
                        Gladiator.perkTriggered = true;
                        break;

                    case "Defeating-Wild-Pokemon":

                        modifiedEXP = Gladiator.originalEXP + (int) num;
                        Gladiator.perkTriggered = true;
                        break;
    ...
    private static void giveCustomPerk (Player player) throws ObjectMappingException{
        ...
        int options = PerkGetters.getCustomPerkAmount(10);
        ...
        if (options > 1) {
            ...
            map = PerkGetters.getCustomPerkMap(10, rng);
            perkNum = rng;

        } else {

            map = PerkGetters.getCustomPerkMap(10, 1);
            perkNum = 1;
        ...
        if (modifier[1].equalsIgnoreCase("%player-level%")) {
            ...
            modNum = AccountsHandler.getLevel("Gladiator", player);
