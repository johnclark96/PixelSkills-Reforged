...
public class ArtificerPerks {
    ...
    private static void givePerk (String task, Player player) throws ObjectMappingException {
        ...
        int amount = Integer.parseInt(PerkGetters.getPerkModifiers(1, "").get("Amount"));
        String[] modifier = PerkGetters.getPerkModifiers(1, "").get("Modifier").split(" ");
        ...
        if (modifier[1].equalsIgnoreCase("%player-level%")) {
            ...
            num = AccountsHandler.getLevel("Artificer", player);
    ...
    private static void giveCustomPerk (Player player) throws ObjectMappingException, IOException {

        int options = PerkGetters.getCustomPerkAmount(1);
        ...
        if (options > 1) {
            ...
            map = PerkGetters.getCustomPerkMap(1, rng);
            perkNum = rng;

        } else {

            map = PerkGetters.getCustomPerkMap(1, 1);
            perkNum = 1;
