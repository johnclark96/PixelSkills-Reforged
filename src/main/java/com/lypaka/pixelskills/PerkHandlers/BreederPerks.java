...
import com.lypaka.pixelskills.Skills.Breeder;
...
public class BreederPerks {
            ...
            case "Hatching-Eggs":
                ...
                if (statsToMod.contains(", ")) {
                    ...
                    for (String stat : stats) {
                        ...
                        IVModifier.modifyIVs(Breeder.pokemon, stat, num, function);

                    }

                } else {

                    IVModifier.modifyIVs(Breeder.pokemon, statsToMod, num, function);

                }

                player.sendMessage(FancyText.getFancyText(MessageGetters.getPerkMessage(GeneralGetters.getConfigFromSkill("Breeder"), task)));
                break;


            case "Making-Eggs":

                pokemon = Breeder.pokemon;
    ...
    private static void giveCustomPerk (Player player) throws ObjectMappingException {
        ...
        int options = PerkGetters.getCustomPerkAmount(4);
        ...
        if (options > 1) {
            ...
            map = PerkGetters.getCustomPerkMap(4, rng);
            perkNum = rng;

        } else {

            map = PerkGetters.getCustomPerkMap(4, 1);
            perkNum = 1;
        ...
        if (modifier[1].equalsIgnoreCase("%player-level%")) {
            ...
            modNum = AccountsHandler.getLevel("Breeder", player);
            ...
            case "item":
                if (prize.contains(", ")) {
                    ...
                    for (String prz : prizes) {
                        ...
                        player.sendMessage(FancyText.getFancyText(MessageGetters.getCustomPerkMessage(4, perkNum)
