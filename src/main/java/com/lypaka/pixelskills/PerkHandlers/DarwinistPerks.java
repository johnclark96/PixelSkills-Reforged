...
public class DarwinistPerks {
    ...
    private static void givePerk (String task, Player player) throws ObjectMappingException {
        ...
        player.sendMessage(FancyText.getFancyText(MessageGetters.getPerkMessage(GeneralGetters.getConfigFromSkill("Darwinist"), "")));
            ...
            case "item":
                if (prize.contains(", ")) {
                    ...
                    for (String prz : prizes) {
                        ...
                        player.sendMessage(FancyText.getFancyText(MessageGetters.getCustomPerkMessage(8, perkNum)
