...
public class LooterPerks {
    ...
    private static void givePerk (String task, Player player) throws ObjectMappingException {
        ...
        int amount = Integer.parseInt(PerkGetters.getPerkModifiers(12, "").get("Amount-Given-From-List"));
        String[] modifier = PerkGetters.getPerkModifiers(12, "").get("Modifier").split(" ");
        ...
        if (modifier[1].equalsIgnoreCase("%player-level%")) {
            ...
            num = AccountsHandler.getLevel("Looter", player);
        ...
        player.sendMessage(FancyText.getFancyText(MessageHandlers.getPerkMessage(GeneralGetters.getConfigFromSkill("Looter"), "")));

    }

    private static void giveCustomPerk (Player player) throws ObjectMappingException {

        int options = PerkGetters.getCustomPerkAmount(12);
        ...
        if (options > 1) {
            ...
            map = PerkGetters.getCustomPerkMap(12, rng);
            perkNum = rng;

        } else {

            map = PerkGetters.getCustomPerkMap(12, 1);
            perkNum = 1;
        ...
        if (modifier[1].equalsIgnoreCase("%player-level%")) {
            ...
            modNum = AccountsHandler.getLevel("Looter", player);
            ...
            case "item":
                if (prize.contains(", ")) {
                    ...
                    for (String prz : prizes) {
                        ...
                        player.sendMessage(FancyText.getFancyText(MessageHandlers.getCustomPerkMessage(12, perkNum)
